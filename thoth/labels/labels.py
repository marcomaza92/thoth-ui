...
introduction = {
    ...
    "usage_i": "Este proyecto funciona como rolling-documentación, \
        donde registramos las cosas que vamos agregando y experimentando.",
}

branching = {
    "title": "Branching",
    "content_i": "Tomamos la decisión de hacer un modelo de branching con tres ramas: \
    ...
    "content_ii": "Extendimos el modelo mencionado (basado en GitLab Flow) \
    ...
    "content_iii": "Para el modelo de branching, utilizamos un derivado de Conventional Commits \
...
commits = {
    "title": "Commits",
    "content_i": "Los commits son parte vital del flujo de trabajo de un proyecto ya que nos \
        ...
        y más.",
    "content_ii": "Por ello, decidimos usar como referencia principal la metodología de \
    ...
    "content_iii": "Otra cosa a tener en cuenta es el tono en el que escribimos los mensajes. \
...
ci_cd = {
    "title": "CI/CD",
    "content_i": "En la etapa de CI/CD apuntamos a hacer un flujo simple pero \
    completo, o al menos que cubra de manera ilustrativa los 3 stages más comunes, \
    los cuales son:",
    "list_i": ["test", "build", "deploy"],
    "content_ii": "Podemos ver esto reflejado en el archivo yaml:",
    "image_i": "/ci_cd_i.png",
    "content_iii": "Con esto presente, en cada stage pusimos a correr ciertas tareas \
...
next_steps = {
    ...
    "content_i": "Interesado por saber más y ver cómo se va desarrollando las metodologías y \
